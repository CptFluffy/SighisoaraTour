...
//This Adapter is used for the events list and uses the list_item.xml as a layout, which does not include a location icon.
public class AttractionAdapter extends ArrayAdapter<Attraction> {
    ...
    public AttractionAdapter(Activity context, ArrayList<Attraction> attractions, int colorResoureceId) {
